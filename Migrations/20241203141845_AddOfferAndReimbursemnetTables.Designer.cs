...
namespace SmaHauJenHoaVij.Migrations
{
    ...
    [Migration("20241203141845_AddOfferAndReimbursemnetTables")]
    partial class AddOfferAndReimbursemnetTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmaHauJenHoaVij.Core.Domain.Users.Admins.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dbcca975-02ed-460f-9a02-53c989dbcfe0"),
                        ...
                        new
                        {
                            Id = new Guid("9fe345a7-54b5-48fc-8805-7e1560c68274"),
