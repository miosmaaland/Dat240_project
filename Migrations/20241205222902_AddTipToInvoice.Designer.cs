...
namespace SmaHauJenHoaVij.Migrations
{
    ...
    [Migration("20241205222902_AddTipToInvoice")]
    partial class AddTipToInvoice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmaHauJenHoaVij.Core.Domain.Users.Admins.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ddad7ec1-247f-4047-b546-0cec3304e4a4"),
                        ...
                        new
                        {
                            Id = new Guid("3aa3f4f6-2c4d-4fae-a4ef-0c0bff71ba85"),
