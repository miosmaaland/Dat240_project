...
namespace SmaHauJenHoaVij.Migrations
{
    ...
    [Migration("20241206122724_AddCreatedAtToReimbursement")]
    partial class AddCreatedAtToReimbursement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmaHauJenHoaVij.Core.Domain.Users.Admins.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("605e8acf-2c2b-4200-9c61-204d1dd02a86"),
                        ...
                        new
                        {
                            Id = new Guid("27beee8a-2e0a-41bb-adc6-41caab28098a"),
