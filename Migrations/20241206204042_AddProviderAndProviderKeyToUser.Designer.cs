...
namespace SmaHauJenHoaVij.Migrations
{
    ...
    [Migration("20241206204042_AddProviderAndProviderKeyToUser")]
    partial class AddProviderAndProviderKeyToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmaHauJenHoaVij.Core.Domain.Users.Admins.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b557dd76-aa2e-4061-8925-49361cbf10f1"),
                        ...
                        new
                        {
                            Id = new Guid("025360da-4719-4ed1-922d-889ad7b16e53"),
